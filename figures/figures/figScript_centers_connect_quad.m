...
rmroiCell = ff_rmroiCell(cr,list_subInds, list_roiNames, list_dtNames, list_rmNames, 'list_path', list_path);
...
for kk = 1:numRms
    ...
    % The version of the function I have does not take vfc
    linX = ff_rmroiLinearize(rmroiSubjects, 'x0'); 
    linY = ff_rmroiLinearize(rmroiSubjects, 'y0'); 
